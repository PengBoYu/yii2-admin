...
namespace pengboyu\admin\components;
 ...
 * 
 * ```
 * Yii::$container->set('pengboyu\admin\components\Configs',[
 *     'db' => 'customDb',
 *     'menuTable' => 'admin_menu',
 * ]);
 * ```
...
{
    const CACHE_TAG = 'pengboyu.admin';
    ...
    public static function instance()
    {
        if (self::$_instance === null) {
            $type = ArrayHelper::getValue(Yii::$app->params, 'pengboyu.admin.configs', []);
