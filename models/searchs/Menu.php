...
namespace pengboyu\admin\models\searchs;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use pengboyu\admin\models\Menu as MenuModel;

/**
 * Menu represents the model behind the search form about [[\pengboyu\admin\models\Menu]].
 * 
